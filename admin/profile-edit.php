...
if(isset($_POST['form1'])) {
	...
	if($_SESSION['user']['role'] == 'Super Admin') {
	    ...
	    if($valid == 1) {
	    	...
	    	$success_message = 'La información se actualizó con éxito.';
	    }
	}
	else {
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La foto se actualizó con éxito.';
...
if(isset($_POST['form3'])) {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'La contraseña de usuario se actualizó con éxito.';
    }
}
?>
          				...
          				<div class="tab-pane active" id="tab_1">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Dirección de correo <span>*</span></label>
										<?php
										if($_SESSION['user']['role'] == 'Super Admin') {
											?>
												<div class="col-sm-4">
