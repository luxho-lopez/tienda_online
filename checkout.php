                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
                                ...
                                Debe completar toda la información de facturación y envío desde su panel de control para poder pagar el pedido. Por favor complete la información <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">ingresando a este enlace</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
