...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_name'])) {
        $valid = 0;
        $error_message .= "El nombre del estado no puede estar vacío.<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'El nombre del estado ya existe.<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'El estado se actualizó con éxito.';
    }
}
?>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nombre del estado <span>*</span></label>
                    <div class="col-sm-4">
