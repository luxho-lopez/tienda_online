...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= 'Debes seleccionar un estado.<br>';
    }
    ...
    if($_POST['amount'] == '') {
        ...
        if(!is_numeric($_POST['amount'])) {
            $valid = 0;
            $error_message .= 'Debes ingresar un número válido.<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'El costo de envío se agregó con éxito.';
    }
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'El costo de envío para el resto del mundo se actualiza con éxito.';
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Seleccionar estado <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: Si un estado no existe en la lista anterior, se aplicará el siguiente costo de envío "Resto del mundo" sobre ese.</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Gastos de envío (Resto del País)</h1>
    </div>
</section>
