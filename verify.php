...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Su correo electrónico se verificó con éxito. Ahora puede iniciar sesión en nuestro sitio web.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Clic aquí para ingresar</a></p>';     
    }
}
?>
