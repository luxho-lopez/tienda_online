...
if(isset($_POST['form1'])) {
    ...
    if($path == '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Debe cargar un archivo jpg, jpeg, gif o png<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'El logotipo se actualizó con éxito.';
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Favicon se actualizo correctamente.';
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'La sección Configuración de On-Off se actualizó con éxito.';
}
...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'La configuración de Home se actualizó con éxito.';
}
...
if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_title'])) {
        $valid = 0;
        $error_message .= 'El título de la llamada a la acción no puede estar vacío.<br>';
    }

    if(empty($_POST['cta_content'])) {
        $valid = 0;
        $error_message .= 'El contenido de la llamada a la acción no puede estar vacío.<br>';
    }

    if(empty($_POST['cta_read_more_text'])) {
        $valid = 0;
        $error_message .= 'Llamada a la acción Leer más, El texto no puede estar vacío<br>';
    }

    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'Llamada a la acción Leer más, La URL no puede estar vacía<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Los datos de la llamada a la acción se actualizan correctamente.';
...
if(isset($_POST['form6_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Los datos de productos destacados se actualizaron correctamente.';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_title'])) {
        $valid = 0;
        $error_message .= 'El último título del producto no puede estar vacío.<br>';
    }

    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'El último subtítulo del producto no puede estar vacío.<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Los últimos datos del producto se actualizaron con éxito.';
...
if(isset($_POST['form6_6'])) {
    ...
    if(empty($_POST['popular_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'El subtítulo de producto popular no puede estar vacío.<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Los datos de productos populares se actualizan con éxito.';
...
if(isset($_POST['form6_3'])) {
        ...
        $success_message = 'El texto del boletín se actualizó con éxito.';
...
if(isset($_POST['form7_3'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'El banner de la página de olvido de contraseña se actualizó correctamente.';
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'El banner de la página de restablecimiento de contraseña se actualizó correctamente.';
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'El banner de la página de la categoría del producto se actualizó correctamente.';
...
if(isset($_POST['form9'])) {
    ...
    $success_message = 'La configuración de pago se actualizó con éxito.';
}
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Head and Body Script se actualizó con éxito.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_3" data-toggle="tab">Footer & Contacto</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Config. de mensajes</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Productos</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Config. de inicio</a></li>
                        <li><a href="#tab_7" data-toggle="tab">Config. de Banner</a></li>
                        <li><a href="#tab_9" data-toggle="tab">Config. de pago</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Sección Boletín </label>
                                        <div class="col-sm-3">
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Mapa </label>
                                        <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_6">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección de productos más recientes </label>
                                        <div class="col-sm-4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Palabra clave </label>
                                        <div class="col-sm-8">
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Sección de productos más recientes</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Último título del producto<span>*</span></label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Cambiar el banner de la página de inicio de sesión</h4>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Cambiar el banner de la página de registro</h4>
                                        Seleccionar Foto<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Banner de página de olvido de contraseña existente</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_forget_password; ?>" alt="" style="width: 100%;height:auto;">   
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Cambiar el banner de la página de olvido de contraseña</h4>
                                        Seleccionar Foto<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Cambiar el banner de la página del carrito</h4>
                                        Seleccionar Foto<input type="file" name="photo">
                        ...
                        <div class="tab-pane" id="tab_9">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">PayPal - Correo de negocios </label>
                                            <div class="col-sm-5">
