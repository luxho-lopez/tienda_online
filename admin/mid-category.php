    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">¡Ten cuidado! Todos los productos y las categorías de nivel final de esta categoría de nivel medio se eliminarán de todas las tablas, como la tabla de pedidos, la tabla de pagos, la tabla de tallas, la tabla de colores, la tabla de clasificación, etc.</p>
            </div>
