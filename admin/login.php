...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['email']) || empty($_POST['password'])) {
        $error_message = 'El correo electrónico y/o la contraseña no pueden estar vacíos.<br>';
    } else {
        ...
        if($total==0) {
            $error_message .= 'La dirección de Email no coincide<br>';
        } else {       
  	...
  	<div class="login-box-body">
		...
		<form action="" method="post">
			...
			<div class="row">
				...
				<div class="col-xs-4">
					<input type="submit" class="btn btn-success btn-block btn-flat login-button" name="form1" value="Iniciar Sesión">
				</div>
			</div>
		</form>
	</div>
