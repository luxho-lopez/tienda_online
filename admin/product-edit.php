...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Debe seleccionar una categoría de nivel final.<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'El producto se actualizo correctamente.';
    }
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Precio anterior<br><span style="font-size:10px;font-weight:normal;">(En MX)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Precio actual <span>*</span><br><span style="font-size:10px;font-weight:normal;">(En MX)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select name="p_is_featured" class="form-control" style="width:auto;">
									...
									<option value="1" <?php if($p_is_featured == '1'){echo 'selected';} ?>>Si</option>
								</select> 
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select name="p_is_active" class="form-control" style="width:auto;">
									...
									<option value="1" <?php if($p_is_active == '1'){echo 'selected';} ?>>Si</option>
								</select> 
							</div>
						</div>
						<div class="form-group">
