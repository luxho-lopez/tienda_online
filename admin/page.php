...
if(isset($_POST['form_about'])) {
    ...
    if($path != '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Debe tener que cargar un archivo jpg, jpeg, gif o png<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'La información de la página se actualizó con éxito.';
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Nueva foto de portada</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Palabras clave </label>
                                        <div class="col-sm-8">
