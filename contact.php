...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Por favor, introduzca su dirección de correo.\n';
    }
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Por favor, introduce una dirección de correo válida.\n';
        }
    }
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="visitor_name" placeholder="Ingrese su Nombre">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Correo</label>
                                        <input type="email" class="form-control" name="visitor_email" placeholder="Ingrese su correo">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Número de teléfono</label>
                                        <input type="text" class="form-control" name="visitor_phone" placeholder="Ingrese su numero de teléfono">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Mensaje</label>
                                        <textarea name="visitor_message" class="form-control" rows="9" cols="25" placeholder="Ingrese su mensaje"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
